    ...
    <form action="result.php" method="POST">
        <table border="1" align="center" cellpadding="10">
            ...
            <tr>
                <td>守備位置：</td>
                <td>
                    投手<input type="checkbox" name="mPosition[]" value="投手">
                    捕手<input type="checkbox" name="mPosition[]" value="捕手">
                    內野手<input type="checkbox" name="mPosition[]" value="內野手">
                    外野手<input type="checkbox" name="mPosition[]" value="外野手">
                </td>
            </tr>
